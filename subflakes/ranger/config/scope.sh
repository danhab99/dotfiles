...
handle_mime() {
    ...
    case "${mimetype}" in
        ...
        *sqlite3)
        ...
        # application/javascript|text/javascript|application/x-javascript|application/typescript|text/x-typescript)
        #     bat --style=numbers --color=always "${FILE_PATH}" || cat "${FILE_PATH}"
        #     exit 5;;
    esac
}
